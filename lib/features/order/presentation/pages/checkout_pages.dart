...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  static const List<_PaymentOption> _paymentOptions = [
    _PaymentOption(
      ...
      label: 'Helmet Wallet',
      subtitle: 'Bayar instant dengan Helmet Wallet',
  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    final success = await orderProv.checkout(
      ...
      totalAmount: (cartProv.cart?.totalPrice ?? 0).toDouble(),
      items: cartProv.cart?.items.map((item) => OrderItemModel(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${item.quantity} x ${_formatPrice(item.price.toDouble())}',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            _formatPrice((cart?.totalPrice ?? 0).toDouble()),
